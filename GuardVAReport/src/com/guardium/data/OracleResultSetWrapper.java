...
import com.guardium.utils.ConNoTX;

public class OracleResultSetWrapper implements ResultSet{
	...
	public ResultSetMetaData getMetaData() throws SQLException {
		return new OracleMetaDataWrapper(rs.getMetaData());
	}
	...
	static Method getObjectMethodI;
	static Method getObjectMethodS;
	
	static {
		Class<ResultSet> clazz = ResultSet.class;
		try {
			getObjectMethodI = clazz.getMethod("getObject", Integer.TYPE, Class.class);
			getObjectMethodS = clazz.getMethod("getObject", String.class, Class.class);
	...
	public <T> T getObject(int columnIndex, Class<T> type) throws SQLException {
		...
		return (T) ConNoTX.invokeMethod(getObjectMethodI, rs, columnIndex, type);
	}
	...
	public <T> T getObject(String columnLabel, Class<T> type)
			throws SQLException {
		//We use reflection here so that this java 7 method invocation also compiles with java 6
		return (T) ConNoTX.invokeMethod(getObjectMethodI, rs, columnLabel, type);
	}
